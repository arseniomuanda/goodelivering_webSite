        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 text-center">
                    <h2 data-aos="fade-up">PETRÓLEO E GÁS, AQUISIÇÕES GERAIS, SERVIÇOS LOGÍSTICOS, MÃO-DE-OBRA E SERVIÇOS DE VISTO.</h2>
                    <br><br><br><br><br>
                    <div data-aos="fade-up" data-aos-delay="200">
                        <a href="/public/about" class="btn-get-started">Ver mais</a>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content" style="background-color: #F0F0F0;">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <h5 class="modal-title mb-2 mt-4" style="color:#1b2f45;">Notícia? Alertamos!</h5>
                            <p style="color:#1b2f45;">Quer receber novidades no seu e-mail? Assine a nossa newsletter.</p>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" form="emailForm" type="submit">Enviar</button>
                </div>
            </div>
        </div>
    </div>
